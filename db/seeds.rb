...
work = Work.create(
  [
    ...
    name: "REDU.CO",
    url: "redu.co",
    desc:[ "Would you reduce your carbon footprint, but not sure how?", "Have a look at REDU.CO.", "A fan way to be better to the enviroment, with challenges, connect with friends and compare your CO2 emissions, and more.", "Our LeWagon final project, built with Rails, JS, Webpack.", "To log in, you can use: juanpablo@mail.com/ 123456789 combination"]},
    ...
    name: "MUNDO COCHE",
    url: "mundo-coche.com",
    desc: ["Simple landing page for an used-parts dealer. With email request form.", "Built with Rails"]},
    ...
    desc: ["Skillfull developers to hire here!", "Find a developer with a desired skillset around you or the other side of the world.", "LeWagon side project. Built with Rails, JS, Webpack.", "To log in, you can use: guest@guest.com/ 123456 combination"]},
